...
#dollar value conversion
    ...
    for a in ls_money:
        ...
        b=' '.join(b)
        if b=="dollars" or b=="dollar" or b=="Dollar":
            symbol="$"
        elif b=="euros" or b=="euro" or b=="Euro":
            symbol="€"
        elif b=="yens" or b=="yen" or b == "Yen":
            symbol="¥"
        elif b=="pound" or b=="pounds" or b=="Pounds":
            symbol="£"
        else:
            symbol=""
...
def convert(para):
    return Translator(StringMultiplier(para))